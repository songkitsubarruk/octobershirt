		...
		<br>
			...
			<div class="mo_wpns_small_layout hidden">	
				...
				<form id="mo_wpns_advanced_reports" method="post" action="">
					...
					<tr>
					<td width="33%">WordPress Username : <input class="mo_wpns_table_textbox" type="text" '.$disabled.' name="username" required="" placeholder="Search by username" value=""></td>
					<td width="33%">IP Address :<input class="mo_wpns_table_textbox" type="text" '.$disabled.' name="ip" required="" placeholder="Search by IP" value=""></td>
					...
					<td width="33%">From Date : <input '.$disabled.' class="mo_wpns_table_textbox" type="date"  name="fromdate"></td>
					<td width="33%">To Date :<input '.$disabled.' class="mo_wpns_table_textbox" type="date"  name="todate"></td>
					</tr>
					</table>
