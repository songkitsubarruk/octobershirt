...
<article class="page-box">
  ...
  <div class="new-text">
    ...
    <div class="second-border">
      <a href="<?php echo esc_url( get_permalink() );?>" title="<?php esc_attr_e( 'Read More', 'perfect-blog' ); ?>"><?php echo esc_html(get_theme_mod('perfect_blog_button_text','Read complete post'));?></a><span class="screen-reader-text"><?php esc_html_e( 'Read complete post','perfect-blog' );?></span>
    </div>
  </div>
